...
function About() {
    ...
    return (
        <>
            <Container>
                <h1 className="about-heading raleway" style={{ marginTop:"100px" }}>
